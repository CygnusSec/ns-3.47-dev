...
#ifndef SCENARIO1_TRAFFIC_H
#define SCENARIO1_TRAFFIC_H
...
Scenario1Applications InstallScenario1Traffic(
    const NodeContainer& nodes,
    const Ipv4InterfaceContainer& interfaces,
    double trafficStartS,
    double simulationTimeS);

/** Add the optional saturated TCP stress flow from R to S1. */
...
bool WriteScenario1Metrics(const Scenario1Applications& applications,
...
bool ValidateScenario1Traffic(Ptr<FlowMonitor> monitor,
